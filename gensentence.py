...
food = ['ไข่เจียว', 'ไข่คน', 'ข้าวผัด', 'ซูชิ', 'ราเมง']
places = ['ฮ่องกง', 'นิวยอร์ค', 'ปารีส', 'โรม', 'ลอนดอน', 'กรุงเทพ', 'เชียงใหม่', 'ภูเก็ต', 'ไทย', 'อิตาลี', 'ฝรั่งเศส', 'ญี่ปุ่น', 'เกาหลี', 'อเมริกา', 'ยุโรป', 'นิวซีแลนด์']
movies = ['อเวนเจอร์', 'สเตรนเจอร์ธิงส์', 'อินเซปชั่น', 'แฮรี่พ็อตเตอร์', 'เกมอำนาจ', 'เกมออฟโธรนส์']
...
activities = ['ฟุตบอล', 'เต้น', 'ขับรถ', 'ขี่จักรยาน', 'เซิร์ฟบอร์ด']
